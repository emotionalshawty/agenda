...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<String> Contactes = new ArrayList<>();
        ...
        System.out.println("5. Sortir de l'agenda.");
        ...
        switch (opcio) {
            case 1:
                ...
                Contactes.add("Nom:"+nom+"Telèfon:"+tel+"Email:"+email );

                System.out.println("S'ha creat l'entrada de  " + nom);
                break;
            case 2:
